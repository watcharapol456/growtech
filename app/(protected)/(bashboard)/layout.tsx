...
import { Sidebar_Menu } from "@/constants/const-sidebar";
...
const chakraPetch = Chakra_Petch({
  weight: ["400", "700"], // ระบุน้ำหนักฟอนต์ที่ต้องการใช้
  subsets: ["thai"],
});
        ...
        <section className="flex h-[calc(100%-150px)] overflow-hidden">
          <section>
            <div className="sticky left-0 top-0 flex h-full w-[300px] flex-col gap-6 bg-[#9ae2cf]">
              ...
              <div className="flex items-center justify-center space-x-2 border-b-2 mt-60 py-2 w-[200px] mx-auto ">
                <Image
                  src="/assets/user.svg"
                  width={50}
                  height={30}
